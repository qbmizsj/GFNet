...
class Global_Filter(nn.Module):
    def __init__(self, h=18, w=21, d=10, dim=1000):
        super().__init__()
...
# Block [N x 3888 x 1000] ----> [N x 3888 x 1000]
...
class GFNet(nn.Module):
    def __init__(self, img_size=(181, 217, 181), patch_size=(10, 10, 10), embed_dim=1000, num_classes=2, in_channels=1, drop_rate=0.5, depth=8, mlp_ratio=2., representation_size=None, uniform_drop=False, drop_path_rate=0.6, norm_layer=False, dropcls=0.25):
        super().__init__()
